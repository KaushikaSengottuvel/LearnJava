...
public class CalculateScoresService implements ICalculateScores {
	...
	// =============================================================================
	@Override
	public void saveTotalMarks(Student student) throws StudentNotFoundException {
		...
		if (student instanceof PrimaryStudent) {
			...
			totalMarks = primaryStudent.getEnglish() + primaryStudent.getMathematics() + primaryStudent.getScience()
					+ primaryStudent.getSocial();

		} else if (student instanceof SecondaryStudent) {

			SecondaryStudent secondaryStudent = (SecondaryStudent) student;

			totalMarks = secondaryStudent.getMathematics() + secondaryStudent.getBiology()
					+ secondaryStudent.getPhysics() + secondaryStudent.getChemistry();
		}
	...
	// =============================================================================
	@Override
	public float getPercentageOfStudent(long rollNo) throws MarksNotCalculatedException, StudentNotFoundException {
	...
	private Student checkStudentIsPresent(long rollNo) throws StudentNotFoundException {
	...
	private Mark checkStudentMarkIsProcessed(long rollNo) throws MarksNotCalculatedException {
		for (Mark mark : marks) {
